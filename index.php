         ...
         <h3 class="wow fadeInLeft hero-sub-heading" data-wow-delay="500ms">Get the best of big apple</h3>
          <form action="" class="hero__form shake">
              ...
              <div class="form-submit">
                  <button class="btn btn-common" type="submit" id="form-submit">ORDER NOW</button>
...
<!--             <div class="col-md-12 wow animated fadeInLeft" data-wow-delay=".2s">
                ...
                <div class="col-md-4 col-6">
                  <div class="awwards-container">
                     ...
                     <div class="awwards-header">
                       ...
                       You can check our reviews <a href="https://goo.gl/maps/NYr6dBGJNvuAzx4R8">here</a>
                     </div>
                     <!-- <div class="awwards-text">
                      You can check our rating and reviews on <a href="https://goo.gl/maps/NYr6dBGJNvuAzx4R8">google page</a>
                     </div> -->
                  </div>
                </div>
              </div>
    ...
    <section class="Material-about-section section-padding">
      <div class="container">
        ...
        <div class="row wow animated fadeInLeft welcome-about" data-wow-delay=".2s">
         ...
         <!--  <div class="founder">
            <img class="founder-img" src="assets/images/costumer.jpg" alt="signature">
            <div class="founder-container">
              <div class="founder-name">Melissa McBride</div>
              <div class="founder-role">FOUNDER</div>
            </div>
            <img src="assets/images/signature-1-1.png" alt="signature">
          </div> -->
         </div>
        </div>
      </div>
